...
#include "livox_laser_simulation/plugin_pointcloud.h"

namespace gazebo {

GZ_REGISTER_SENSOR_PLUGIN(PluginPointCloud)

void PluginPointCloud::Load(gazebo::sensors::SensorPtr _parent, sdf::ElementPtr sdf) {
...
void PluginPointCloud::OnNewLaserScans() {
    if (rayShape) {
